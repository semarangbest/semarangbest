...
?>
 <header id="site-header" class="site-header dynamic-header <?php echo esc_attr( hello_get_header_layout_class() ); ?>" role="banner">
	<div class="header-inner">
		<div class="site-branding show-<?php echo hello_madxartwork_get_setting( 'hello_header_logo_type' ); ?>">
			<?php if ( has_custom_logo() && ( 'title' !== hello_madxartwork_get_setting( 'hello_header_logo_type' ) || $is_editor ) ) : ?>
				<div class="site-logo <?php echo hello_show_or_hide( 'hello_header_logo_display' ); ?>">
					<?php the_custom_logo(); ?>
				</div>
			<?php endif;

			if ( $site_name && ( 'logo' !== hello_madxartwork_get_setting( 'hello_header_logo_type' ) || $is_editor ) ) : ?>
			...
			if ( $tagline && ( hello_madxartwork_get_setting( 'hello_header_tagline_display' ) || $is_editor ) ) : ?>
		...
		<?php if ( $header_nav_menu ) : ?>
			...
			<div class="site-navigation-toggle-holder <?php echo hello_show_or_hide( 'hello_header_menu_display' ); ?>">
				<div class="site-navigation-toggle">
					...
					<span class="madxartwork-screen-only">Menu</span>
				</div>
			</div>
